  ...
  switch (state) {
    case 0:
      ...
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(32);
      if (set_contains(sym__name_character_set_1, 668, lookahead)) ADVANCE(138);
      END_STATE();
    case 1:
    ...
    case 71:
      ...
      if (lookahead == '~') ADVANCE(127);
      if (lookahead == 0x2248) ADVANCE(133);
      if (set_contains(sym__name_character_set_2, 776, lookahead)) ADVANCE(138);
      END_STATE();
    case 72:
      ACCEPT_TOKEN(aux_sym_positive_scales_token1);
      if (set_contains(sym__name_character_set_2, 776, lookahead)) ADVANCE(138);
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_block] = STATE(38),
    [sym_anchor_statement] = STATE(131),
    [sym_loopy_fysh] = STATE(111),
    [sym_happy_fysh] = STATE(120),
    [sym_grilled_fysh] = STATE(10),
    [sym_loop_statement] = STATE(38),
    [sym_if_statement] = STATE(38),
    [sym_expression_statement] = STATE(131),
    [sym_inc_statement] = STATE(131),
    [sym_dec_statement] = STATE(131),
  ...
  [2] = {
    [sym_grilled_fysh] = STATE(4),
    [sym__expression] = STATE(4),
    [sym_aquarium] = STATE(4),
    [sym_fysh_bowl] = STATE(4),
    [sym_positive_ident] = STATE(4),
    [sym_positive_scales] = STATE(4),
    [sym_positive_bones] = STATE(4),
    [sym_negative_ident] = STATE(4),
    [sym_negative_scales] = STATE(4),
    [sym_negative_bones] = STATE(4),
  ...
  [7] = {
    ...
    [sym_call_expression] = STATE(4),
    [sym_addition] = STATE(21),
    [aux_sym_aquarium_repeat1] = STATE(109),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [43] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, 0, 4), SHIFT(58),
  [46] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_addition, 2, 0, 4),
  [48] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [50] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, 0, 4), SHIFT(82),
  [53] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, 0, 4), SHIFT(79),
  ...
  [75] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_return_statement, 2, 0, 1),
  [77] = {.entry = {.count = 1, .reusable = true}}, SHIFT(152),
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_anchor_statement, 2, 0, 2),
  [81] = {.entry = {.count = 1, .reusable = true}}, SHIFT(20),
  [83] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment_statement, 3, 0, 12),
  ...
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_bones, 3, 0, 7),
  [91] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_bones, 3, 0, 7),
  ...
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_scales, 3, 0, 6),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative_scales, 3, 0, 6),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fysh_bowl, 3, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fysh_bowl, 3, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 1, 0, 0),
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 1, 0, 0),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_bones, 3, 0, 7),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative_bones, 3, 0, 7),
  [113] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grilled_fysh, 3, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grilled_fysh, 3, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_scales, 3, 0, 6),
  [119] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_scales, 3, 0, 6),
  [121] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_aquarium, 3, 0, 0),
  [123] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_aquarium, 3, 0, 0),
  ...
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_scales, 4, 0, 6),
  [135] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_scales, 4, 0, 6),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_aquarium, 2, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_aquarium, 2, 0, 0),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_ident, 3, 0, 5),
  [143] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative_ident, 3, 0, 5),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_bones, 4, 0, 7),
  [147] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_bones, 4, 0, 7),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 4, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 4, 0, 0),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_aquarium, 4, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_aquarium, 4, 0, 0),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 5, 0, 0),
  [159] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 5, 0, 0),
  ...
  [174] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [177] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(61),
  [180] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(134),
  [183] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(40),
  [186] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  [189] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(77),
  [192] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(156),
  [195] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(78),
  [198] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(44),
  ...
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement_list, 1, 0, 0),
  [211] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statement_list_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [214] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2, 0, 0), SHIFT_REPEAT(61),
  [217] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2, 0, 0), SHIFT_REPEAT(134),
  [220] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2, 0, 0), SHIFT_REPEAT(43),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2, 0, 0),
  [225] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2, 0, 0), SHIFT_REPEAT(52),
  ...
  [234] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statement_list_repeat1, 2, 0, 0), SHIFT_REPEAT(78),
  ...
  [252] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [255] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(82),
  [258] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2, 0, 0), SHIFT_REPEAT(79),
  ...
  [278] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_if_statement, 3, 0, 10), SHIFT(153),
  [281] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2, 0, 0),
  [283] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 2, 0, 0),
  [285] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutine, 2, 0, 3),
  [287] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutine, 2, 0, 3),
  [289] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_loop_statement, 3, 0, 9),
  [291] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_loop_statement, 3, 0, 9),
  [293] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__simple_statement, 2, 0, 0),
  ...
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 5, 0, 16),
  [303] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 5, 0, 16),
  ...
  [335] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__bones, 2, 0, 0),
  [337] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__bones, 2, 0, 0),
  [339] = {.entry = {.count = 1, .reusable = true}}, SHIFT(76),
  [341] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__bones_repeat1, 2, 0, 0),
  [343] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__bones_repeat1, 2, 0, 0), SHIFT_REPEAT(99),
  [346] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__bones_repeat1, 2, 0, 0),
  [348] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__bones_repeat1, 2, 0, 0), SHIFT_REPEAT(81),
  [351] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__scales_repeat1, 2, 0, 0),
  [353] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__scales_repeat1, 2, 0, 0),
  [355] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__scales_repeat1, 2, 0, 0), SHIFT_REPEAT(83),
  [358] = {.entry = {.count = 1, .reusable = true}}, SHIFT(95),
  [360] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__scales, 1, 0, 0),
  [362] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__scales, 1, 0, 0),
  ...
  [370] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__scales, 2, 0, 0),
  [372] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__scales, 2, 0, 0),
  [374] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [376] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [378] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__bones_repeat1, 2, 0, 0), SHIFT_REPEAT(103),
  [381] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__bones_repeat1, 2, 0, 0), SHIFT_REPEAT(89),
  [384] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__scales_repeat1, 2, 0, 0), SHIFT_REPEAT(90),
  [387] = {.entry = {.count = 1, .reusable = false}}, SHIFT(143),
  [389] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_left_sub, 3, 0, 5),
  [391] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_left_sub, 3, 0, 5),
  [393] = {.entry = {.count = 1, .reusable = false}}, SHIFT(125),
  [395] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_positive_scales_repeat1, 2, 0, 0),
  [397] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_positive_scales_repeat1, 2, 0, 0), SHIFT_REPEAT(95),
  [400] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_positive_scales_repeat1, 2, 0, 0),
  ...
  [408] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_spine, 1, 0, 0),
  [410] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_spine, 1, 0, 0),
  [412] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_right_sub, 3, 0, 5),
  [414] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_right_sub, 3, 0, 5),
  [416] = {.entry = {.count = 1, .reusable = true}}, SHIFT(90),
  [418] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_subroutine_repeat1, 2, 0, 0),
  [420] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_subroutine_repeat1, 2, 0, 0), SHIFT_REPEAT(143),
  [423] = {.entry = {.count = 1, .reusable = false}}, SHIFT(19),
  [425] = {.entry = {.count = 1, .reusable = false}}, SHIFT(27),
  [427] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_aquarium_repeat1, 2, 0, 0), SHIFT_REPEAT(59),
  ...
  [466] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inc_statement, 4, 0, 13),
  [468] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dec_statement, 4, 0, 5),
  [470] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_break_statement, 1, 0, 0),
  ...
  [506] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fysh_tank, 3, 0, 0),
  [508] = {.entry = {.count = 1, .reusable = true}}, SHIFT(124),
  [510] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_loopy_fysh, 4, 0, 0),
  [512] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_happy_fysh, 4, 0, 0),
