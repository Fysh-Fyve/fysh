...
enum ts_symbol_identifiers {
  ...
  anon_sym_GT_LT_GT = 9,
  anon_sym_LT_GT_LT = 10,
  anon_sym_LPAREN_PLUSo = 11,
  anon_sym_o_PLUS_RPAREN = 12,
  anon_sym_GT_LT = 13,
  anon_sym_LPAREN_LPAREN_LPAREN = 14,
  anon_sym_AT = 15,
  anon_sym_GT = 16,
  anon_sym_CARET = 17,
  anon_sym_STAR = 18,
  ...
  anon_sym_LBRACK = 23,
  anon_sym_RBRACK = 24,
  aux_sym_positive_literal_token1 = 25,
  sym_one = 26,
  sym_zero = 27,
  anon_sym_LT3 = 28,
  anon_sym_u2661 = 29,
  anon_sym_LT_SLASH3 = 30,
  anon_sym_U0001f494 = 31,
  anon_sym_LT_LT = 32,
  anon_sym_GT_GT = 33,
  anon_sym_AMP = 34,
  anon_sym_PIPE = 35,
  anon_sym_EQ_EQ = 36,
  anon_sym_u2248u2248 = 37,
  anon_sym_TILDE_EQ = 38,
  anon_sym_TILDEu2248 = 39,
  anon_sym_o_TILDE = 40,
  anon_sym_TILDEo = 41,
  anon_sym_o_TILDE_EQ = 42,
  anon_sym_o_TILDEu2248 = 43,
  anon_sym_TILDEo_EQ = 44,
  anon_sym_TILDEou2248 = 45,
  sym_comment = 46,
  sym_multiline_comment = 47,
  sym_source_file = 48,
  sym_subroutine = 49,
  sym_right_sub = 50,
  sym_left_sub = 51,
  ...
  sym_inc_statement = 65,
  sym_dec_statement = 66,
  sym_assignment_statement = 67,
  sym__expression = 68,
  sym_fysh_tank = 69,
  sym_fysh_bowl = 70,
  sym_positive_ident = 71,
  sym_positive_literal = 72,
  sym_negative_ident = 73,
  sym_negative_literal = 74,
  sym_scales = 75,
  sym_binary_expression = 76,
  sym_call_expression = 77,
  sym_addition = 78,
  aux_sym_source_file_repeat1 = 79,
  aux_sym_subroutine_repeat1 = 80,
  aux_sym__statement_list_repeat1 = 81,
  aux_sym_positive_literal_repeat1 = 82,
  aux_sym_scales_repeat1 = 83,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 176) ADVANCE(61);
      if (lookahead == 8776) ADVANCE(57);
      if (lookahead == 9825) ADVANCE(68);
      if (lookahead == 128148) ADVANCE(70);
      if (lookahead == 129425) ADVANCE(37);
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(26)
      if (sym__name_character_set_1(lookahead)) ADVANCE(86);
      END_STATE();
    case 1:
      if (lookahead == '#') ADVANCE(4);
    ...
    case 62:
      ...
      if (lookahead == '+') ADVANCE(10);
      if (lookahead == '~') ADVANCE(79);
      if (sym__name_character_set_2(lookahead)) ADVANCE(86);
      END_STATE();
    case 63:
      ACCEPT_TOKEN(aux_sym_positive_literal_token1);
      if (sym__name_character_set_2(lookahead)) ADVANCE(86);
    ...
    case 79:
      ...
      if (lookahead == 8776) ADVANCE(82);
      END_STATE();
    case 80:
      ACCEPT_TOKEN(anon_sym_TILDEo);
      if (lookahead == '=') ADVANCE(83);
      if (lookahead == 8776) ADVANCE(84);
      END_STATE();
    case 81:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, .production_id = 9),
  [27] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, .production_id = 9),
  ...
  [37] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_addition, 2, .production_id = 4),
  [39] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, .production_id = 4), SHIFT(47),
  [42] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_addition, 2, .production_id = 4),
  [44] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [46] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, .production_id = 4), SHIFT(69),
  [49] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, .production_id = 4), SHIFT(67),
  [52] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_addition, 2, .production_id = 4), SHIFT(35),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2),
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(121),
  ...
  [72] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(68),
  [75] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(109),
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(66),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(35),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 1),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 1),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_statement, 1),
  ...
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_return_statement, 2, .production_id = 1),
  [102] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_anchor_statement, 2, .production_id = 2),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment_statement, 3, .production_id = 10),
  [106] = {.entry = {.count = 1, .reusable = true}}, SHIFT(18),
  [108] = {.entry = {.count = 1, .reusable = true}}, SHIFT(57),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement_list, 1),
  [112] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [114] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(47),
  [117] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(51),
  [120] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(18),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2),
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(44),
  [128] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(68),
  [131] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(109),
  [134] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(66),
  [137] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__statement_list_repeat1, 2), SHIFT_REPEAT(35),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement_list, 2),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_ident, 3, .production_id = 5),
  [144] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_ident, 3, .production_id = 5),
  ...
  [150] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 5),
  [152] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 5),
  ...
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fysh_bowl, 3),
  [160] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fysh_bowl, 3),
  ...
  [166] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_literal, 3),
  [168] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_literal, 3),
  ...
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grilled_fysh, 3),
  [176] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grilled_fysh, 3),
  [178] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_literal, 4),
  [180] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_literal, 4),
  [182] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_literal, 4),
  [184] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative_literal, 4),
  [186] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call_expression, 4),
  [188] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call_expression, 4),
  ...
  [204] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2),
  [206] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2), SHIFT_REPEAT(47),
  [209] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_call_expression_repeat1, 2), SHIFT_REPEAT(69),
  [212] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2), SHIFT_REPEAT(67),
  [215] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_call_expression_repeat1, 2), SHIFT_REPEAT(35),
  ...
  [228] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 3, .production_id = 8),
  [230] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 3, .production_id = 8),
  [232] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_if_statement, 3, .production_id = 8), SHIFT(101),
  [235] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_loop_statement, 3, .production_id = 7),
  [237] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_loop_statement, 3, .production_id = 7),
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutine, 2, .production_id = 3),
  [241] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutine, 2, .production_id = 3),
  [243] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subroutine, 3, .production_id = 6),
  [245] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subroutine, 3, .production_id = 6),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__simple_statement, 2),
  [249] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__simple_statement, 2),
  ...
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_scales_repeat1, 2),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_scales_repeat1, 2),
  [285] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_scales_repeat1, 2), SHIFT_REPEAT(70),
  [288] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scales, 2),
  [290] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scales, 2),
  [292] = {.entry = {.count = 1, .reusable = true}}, SHIFT(70),
  [294] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_positive_literal_repeat1, 2),
  [296] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_positive_literal_repeat1, 2), SHIFT_REPEAT(72),
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_positive_literal_repeat1, 2),
  [301] = {.entry = {.count = 1, .reusable = false}}, SHIFT(105),
  [303] = {.entry = {.count = 1, .reusable = true}}, SHIFT(72),
  [305] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scales, 1),
  [307] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scales, 1),
  [309] = {.entry = {.count = 1, .reusable = true}}, SHIFT(71),
  [311] = {.entry = {.count = 1, .reusable = false}}, SHIFT(128),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_left_sub, 3, .production_id = 5),
  [315] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_left_sub, 3, .production_id = 5),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_right_sub, 3, .production_id = 5),
  [319] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_right_sub, 3, .production_id = 5),
  [321] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [323] = {.entry = {.count = 1, .reusable = true}}, SHIFT(83),
  [325] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_scales_repeat1, 2), SHIFT_REPEAT(83),
  [328] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_subroutine_repeat1, 2),
  [330] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_subroutine_repeat1, 2), SHIFT_REPEAT(128),
  ...
  [345] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dead_fysh, 4),
  [347] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dead_fysh, 4),
  [349] = {.entry = {.count = 1, .reusable = false}}, SHIFT(111),
  [351] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fysh_tank, 3),
  [353] = {.entry = {.count = 1, .reusable = true}}, SHIFT(104),
  [355] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [357] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inc_statement, 4, .production_id = 11),
  [359] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  [361] = {.entry = {.count = 1, .reusable = true}}, SHIFT(108),
  [363] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dec_statement, 4, .production_id = 5),
  [365] = {.entry = {.count = 1, .reusable = false}}, SHIFT(96),
  [367] = {.entry = {.count = 1, .reusable = false}}, SHIFT(113),
  [369] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_loopy_fysh, 4),
  [371] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_happy_fysh, 4),
