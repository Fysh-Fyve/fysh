...
enum {
  ...
  anon_sym_GT_LT_GT = 2,
  anon_sym_LT_GT_LT = 3,
  anon_sym_LPAREN_PLUSo = 4,
  anon_sym_o_PLUS_RPAREN = 5,
  anon_sym_GT_LT = 6,
  anon_sym_LPAREN_LPAREN_LPAREN = 7,
  anon_sym_AT = 8,
  anon_sym_GT = 9,
  anon_sym_CARET = 10,
  anon_sym_STAR = 11,
  anon_sym_POUND_POUND_POUND = 12,
  anon_sym_LT = 13,
  anon_sym_ = 14,
  anon_sym_EQ = 15,
  anon_sym_LBRACK = 16,
  ...
  anon_sym_o_TILDE = 36,
  anon_sym_TILDEo = 37,
  anon_sym_o_TILDE_EQ = 38,
  anon_sym_o_TILDE2 = 39,
  anon_sym_TILDEo_EQ = 40,
  anon_sym_TILDEo2 = 41,
  sym_name = 42,
  sym_comment = 43,
  sym_source_file = 44,
  ...
  sym_inc_statement = 57,
  sym_dec_statement = 58,
  sym_assignment_statement = 59,
  sym__expression = 60,
  sym_fysh_tank = 61,
  sym_fysh_bowl = 62,
  sym_positive_ident = 63,
  sym_positive_literal = 64,
  sym_negative_ident = 65,
  sym_negative_literal = 66,
  sym_scales = 67,
  sym_binary_expression = 68,
  sym_addition = 69,
  aux_sym_source_file_repeat1 = 70,
  aux_sym_positive_literal_repeat1 = 71,
  aux_sym_scales_repeat1 = 72,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 8776) ADVANCE(49);
      if (lookahead == 9825) ADVANCE(63);
      if (lookahead == 128148) ADVANCE(65);
      if (lookahead == '\t' ||
          lookahead == '\n' ||
          lookahead == '\r' ||
          lookahead == ' ') SKIP(0)
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [anon_sym_GT_LT_GT] = ACTIONS(7),
    [anon_sym_LPAREN_PLUSo] = ACTIONS(9),
    [anon_sym_o_PLUS_RPAREN] = ACTIONS(9),
    [anon_sym_GT_LT] = ACTIONS(11),
  ...
  [2] = {
    [sym_grilled_fysh] = STATE(5),
    [sym__expression] = STATE(5),
    [sym_fysh_bowl] = STATE(5),
    [sym_positive_ident] = STATE(5),
    [sym_positive_literal] = STATE(5),
    [sym_negative_ident] = STATE(5),
    [sym_negative_literal] = STATE(5),
    [sym_binary_expression] = STATE(5),
    [sym_addition] = STATE(28),
    [anon_sym_TILDE] = ACTIONS(19),
    [anon_sym_LPAREN_PLUSo] = ACTIONS(21),
    [anon_sym_o_PLUS_RPAREN] = ACTIONS(21),
    ...
    [anon_sym_LT3] = ACTIONS(23),
    [anon_sym_3] = ACTIONS(23),
    [anon_sym_LT_SLASH3] = ACTIONS(23),
    ...
    [anon_sym_TILDE2] = ACTIONS(21),
    [anon_sym_o_TILDE] = ACTIONS(19),
    [anon_sym_TILDEo] = ACTIONS(19),
    [anon_sym_o_TILDE_EQ] = ACTIONS(21),
    [anon_sym_o_TILDE2] = ACTIONS(21),
    [anon_sym_TILDEo_EQ] = ACTIONS(21),
    [anon_sym_TILDEo2] = ACTIONS(21),
    [sym_comment] = ACTIONS(3),
  },
  [3] = {
    [sym_grilled_fysh] = STATE(5),
    ...
    [anon_sym_o_TILDE2] = ACTIONS(27),
    [anon_sym_TILDEo_EQ] = ACTIONS(27),
    [anon_sym_TILDEo2] = ACTIONS(27),
    [sym_comment] = ACTIONS(3),
  },
  [4] = {
    [sym_grilled_fysh] = STATE(5),
  ...
  [5] = {
    ...
    [anon_sym_LPAREN_PLUSo] = ACTIONS(33),
    [anon_sym_o_PLUS_RPAREN] = ACTIONS(33),
  ...
  [6] = {
    ...
    [anon_sym_LPAREN] = ACTIONS(19),
    [anon_sym_RPAREN] = ACTIONS(21),
    [anon_sym_LT3] = ACTIONS(21),
    [anon_sym_3] = ACTIONS(21),
    [anon_sym_LT_SLASH3] = ACTIONS(21),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 3, .production_id = 5),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 3, .production_id = 5),
  ...
  [31] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_addition, 2, .production_id = 2),
  [33] = {.entry = {.count = 1, .reusable = true}}, SHIFT(34),
  [35] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, .production_id = 2), SHIFT(59),
  [38] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, .production_id = 2), SHIFT(50),
  [41] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_addition, 2, .production_id = 2),
  [43] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_addition, 2, .production_id = 2), SHIFT(32),
  [46] = {.entry = {.count = 1, .reusable = false}}, SHIFT(59),
  [48] = {.entry = {.count = 1, .reusable = false}}, SHIFT(50),
  [50] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [52] = {.entry = {.count = 1, .reusable = true}}, SHIFT(88),
  [54] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_assignment_statement, 3, .production_id = 6),
  [56] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expression_statement, 1),
  [58] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_anchor_statement, 2, .production_id = 1),
  ...
  [68] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement_list, 2),
  ...
  [78] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(57),
  [81] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(101),
  [84] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(51),
  [87] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(32),
  [90] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source_file, 1),
  [92] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(13),
  [95] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(51),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement_list, 1),
  [100] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_ident, 3),
  [102] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_ident, 3),
  [104] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative_literal, 4),
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_literal, 4),
  [108] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_literal, 4),
  [110] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_literal, 4),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fysh_bowl, 3),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fysh_bowl, 3),
  [116] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative_literal, 3),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_literal, 3),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_positive_literal, 3),
  [122] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_positive_literal, 3),
  [124] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_grilled_fysh, 3),
  [126] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_grilled_fysh, 3),
  [128] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_negative_ident, 3),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_negative_ident, 3),
  ...
  [138] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_expression, 1),
  [140] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_expression, 1),
  ...
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 3, .production_id = 4),
  [150] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_if_statement, 3, .production_id = 4), SHIFT(85),
  [153] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 3, .production_id = 4),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2),
  [157] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 2),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 5, .production_id = 7),
  [161] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 5, .production_id = 7),
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_loop_statement, 3, .production_id = 3),
  [165] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_loop_statement, 3, .production_id = 3),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 3),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__simple_statement, 2),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__simple_statement, 2),
  ...
  [187] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scales, 1),
  [189] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scales, 1),
  [191] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scales, 2),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scales, 2),
  [197] = {.entry = {.count = 1, .reusable = true}}, SHIFT(55),
  [199] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_scales_repeat1, 2),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_scales_repeat1, 2),
  [203] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_scales_repeat1, 2), SHIFT_REPEAT(55),
  [206] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_positive_literal_repeat1, 2),
  [208] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_positive_literal_repeat1, 2), SHIFT_REPEAT(56),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_positive_literal_repeat1, 2),
  ...
  [231] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_scales_repeat1, 2), SHIFT_REPEAT(63),
  [234] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dead_fysh, 4),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_dead_fysh, 4),
  ...
  [248] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_inc_statement, 4),
  [250] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dec_statement, 4),
  ...
  [270] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fysh_tank, 3),
