% This is probably the most involved one because it uses the custom commands from use-case.tex.
%
% You can take a look if you want but these should abstract most of the low-level LaTeX stuff
% LaTeX commands can have zero or more arguments. Each argument is wrapped inside {} (squirly braces).
%
